...
//     const {setActive, userMemberships, isLoaded} = useOrganizationList({userMemberships: true}); // eslint-disable-line no-unused-vars

//     const {openCreateOrganization} = useClerk(); // eslint-disable-line no-unused-vars
...
//                     <div onClick={() => { openCreateOraganization(); setIsOpen(false); }} className="p-2 cursor-pointer rounded group hover:bg-gray-100 dark:hover:bg-zinc-800" >
